...
# =============================================================================
# CSV Seperator
# is either semicolon ';' (default) or comma ',' currently doesnt work
...
# =============================================================================
        ...
        img_adress, _ = itex.get_tableofitems(img, 1)
        thresh = grs.cvToBlackWhite(img_adress, 3)
        thicker_font = grs.cvApplyThickerFont(thresh, 3)
        
        # read text from image and create list
        adresse = tx.Texterkennung_Spalten(thicker_font)[0]
...
# =============================================================================
        ...
        csv_path = cs.run_data_to_csv(shop_name, adresse, nurText, table_col_text, fih.getDirOutput())
        # if csv_seperator != ';':
