...
testPathList = testPath.split(';')
for x in testPathList: 
    if (x.find("Tesseract") != -1):
        print(x)

# print(len(testPathList))
# print(testPathList)
# TESSERACTPFAD IN UMGEBUNGSVARIABLEN BEI Path ANGEBEN!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# os.environ["TESSDATA_PREFIX"] = r"C:\DEV\GitHub\Bildverarbeitung\config\tessdata"
# =============================================================================
