...
args = {
	"image": "03052024_Migros_Jannis.jpg",            #03052024_Migros_Jannis.jpg
	"output": "results.csv",
	"min_conf": 0,
	"dist_thresh": 25.0,
	"min_size": 2,
...
Verzeichnis=os.path.join(current_directory,"in", "03052024_Migros_Jannis.jpg")
...
thresh = cv2.dilate(thresh, kernel, iterations=3) #3
